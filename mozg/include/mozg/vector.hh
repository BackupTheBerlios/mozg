// $Id: vector.hh,v 1.2 2006/03/19 20:46:17 lightdruid Exp $
// vector.hh
...
template< class vec_t,class vec_size_t> class vector {
private:
...
template< class vec_t,class vec_size_t> class checked_vector : public vector< vec_t,vec_size_t> {
private:
...
public:
    ...
    checked_vector(const vec_size_t dim)
        : vector< vec_t,vec_size_t>(dim)
    {
        max_abs = 0;
        min_abs = 0;
    }
...
template< class vec_t,class vec_size_t> void zero(checked_vector< vec_t,vec_size_t>*);
