// $Id: matrix.hh,v 1.1 2006/03/18 21:53:18 lightdruid Exp $
// matrix.hh
...
// create matrix
          matrix (const matr_size_t number_rows,
...
// delete matrix
    ...
    template <class matr_t, class matr_size_t> class checked_matrix : 
        public matrix <matr_t, matr_size_t> {
        ...
        checked_matrix (const matr_size_t number_rows, const matr_size_t number_columns)
...
// the type size !!!
    template < class matr_t, class matr_size_t >
        void copy (matr_t number, matrix < matr_t, matr_size_t > *copy);
...
// the type size !!!
    template < class matr_t, class matr_size_t >
        void copy (matr_t * orig, matrix < matr_t, matr_size_t > *copy);
...
// the type size !!!
    template < class matr_t, class matr_size_t >
        void sum (matrix < matr_t, matr_size_t > *matrix,
...
// It transposes matrix
    template < class matr_t, class matr_size_t >
        void transpose (const matrix < matr_t, matr_size_t > &origin_matrix,
...
// the type size !!!
    template < class matr_t, class matr_size_t >
        void randomize (matrix < matr_t, matr_size_t > *matrix,
...
// zero matrix and limits
    template < class matr_t, class matr_size_t >
        void zero (checked_matrix < matr_t, matr_size_t > *);
