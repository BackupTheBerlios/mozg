// $Id: random.cc,v 1.2 2006/03/19 20:46:17 lightdruid Exp $
// 
// random.cc
...
mozgflt random_number(const mozgflt argmin, const mozgflt argmax) {
    mozgflt r;
    static long idum = -1;
...
// and mean value mean
mozgflt gauss(const mozgflt sigma, const mozgflt mean) {
